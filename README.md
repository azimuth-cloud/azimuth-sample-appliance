...
to build an appliance for use with [Azimuth](https://github.com/azimuth-cloud/azimuth)
...
Azimuth CaaS appliances are driven using the
...
It is possible to implement this process yourself, however Azimuth provides a role -
[azimuth_cloud.terraform.infra](https://github.com/azimuth-cloud/ansible-collection-terraform/tree/main/roles/infra) -
